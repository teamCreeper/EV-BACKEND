...
public class CarInfoService {
    ...
    public List<CarInfoDTO> getAllCarInfo(){
        ...
        return carInfos.stream()
                .map(carInfo -> new CarInfoDTO(carInfo.getCarNum(), carInfo.getBrand(), carInfo.getBrand_en(), carInfo.getName(), carInfo.getName_en(), carInfo.getKwh_value(), carInfo.getVehicle_type()))
